...
class PostTypes extends Base {
	...
	public function initialize() {
		...
		$post_columns->add_column(
			'cmb2_field',
			array(
				'label'    => \__( 'CMB2 Field', GSF_TEXTDOMAIN ),
				'type'     => 'post_meta',
				'meta_key' => '_demo_' . GSF_TEXTDOMAIN . '_text', // phpcs:ignore WordPress.DB
				'orderby'  => 'meta_value',
				'sortable' => true,
				'prefix'   => '<b>',
				'suffix'   => '</b>',
			...
			array(
				...
				'callback'     => static function( $post_ids ) {
					foreach ( $post_ids as $post_id ) {
						\update_post_meta( $post_id, '_demo_' . GSF_TEXTDOMAIN . '_text', 'Random stuff' );
					}
	...
	public function load_cpts() {
		...
		$tax = \register_extended_post_type(
				...
				array(
					...
					'admin_cols'         => array(
						...
						'custom_field'   => array(
							'title'    => 'By Lib',
							'meta_key' => '_demo_' . GSF_TEXTDOMAIN . '_text', // phpcs:ignore
							'cap'      => 'manage_options',
						),
						'date'           => array(
							'title'   => 'Date',
			...
			array(
				...
				'singular' => \__( 'Demo', GSF_TEXTDOMAIN ),
				'plural'   => \__( 'Demos', GSF_TEXTDOMAIN ),
			)
		);
		...
		\register_extended_taxonomy(
			...
			array(
				// Override the base names used for labels:
				'singular' => \__( 'Demo Category', GSF_TEXTDOMAIN ),
				'plural'   => \__( 'Demo Categories', GSF_TEXTDOMAIN ),
			)
		);
	}
