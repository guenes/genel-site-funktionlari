...
class ActDeact extends Base {
	...
	public function initialize() {
		...
		\register_activation_hook( GSF_TEXTDOMAIN . '/' . GSF_TEXTDOMAIN . '.php', array( self::class, 'activate' ) );
		\register_deactivation_hook( GSF_TEXTDOMAIN . '/' . GSF_TEXTDOMAIN . '.php', array( self::class, 'deactivate' ) );
	}
